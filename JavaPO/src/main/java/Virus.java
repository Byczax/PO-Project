...
public abstract class Virus {
     ...
     */
    public Location setBorders(int k, int l, int lX, int lY, int sqrtPopulation) {
        Location location;
     ...
     */
    public Location setInfected(Community community, Set<Location> tempInfectedLocations, Location seekLocation) {
